...
Titanium.include('includes/scan.js');
Titanium.include('includes/vcard.js');
...
Titanium.include('includes/connect.js');
Titanium.include('includes/drawer.js');
Titanium.include('windows/main.js');
Titanium.include('windows/front.js');
Titanium.include('windows/activity-stream.js');
...
Titanium.include('windows/connect-chat.js');
Titanium.include('windows/connect-connections.js');
Titanium.include('windows/connect-profile.js');
Titanium.include('windows/connect-reco.js');
Titanium.include('windows/polls.js');
Titanium.include('windows/polls-detail.js');
